...
{
    QStringList names;
    names << "Eabha Bidell" << "Remzi .Arpaci-Dusseau" << "Paul T.Jackson" << "Prentice Hutchison"
        << "Jad Klash" << "Ed Mullis" << "Charles Dickens" << "Lindsey String" << "Ahmed Hanmer"
        << "Andrea C.Arpaci-Dusseau" << "Lee Jong-Khe" << "Norman Epworth" << "Kezia Raw"
