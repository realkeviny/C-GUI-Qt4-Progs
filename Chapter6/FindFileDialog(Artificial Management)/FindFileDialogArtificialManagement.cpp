...
FindFileDialogArtificialManagement::FindFileDialogArtificialManagement(QWidget *parent)
    : QDialog(parent)
{
...
void FindFileDialogArtificialManagement::resizeEvent(QResizeEvent* event)
{
	...
	messageLabel->setGeometry(9, 156+extraHeight, 156+extraHeight, 23);
