#include "FindFileDialogAbsoluteLocation.h"
#include <QtWidgets>

FindFileDialogAbsoluteLocation::FindFileDialogAbsoluteLocation(QWidget *parent)
    : QDialog(parent)
{
	...
	messageLabel->setGeometry(9, 206, 256, 23);
