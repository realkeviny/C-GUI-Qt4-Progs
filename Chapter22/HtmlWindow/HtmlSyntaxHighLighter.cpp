...
HtmlSyntaxHighLighter::HtmlSyntaxHighLighter(QTextDocument* document) :QSyntaxHighlighter(document)
{
...
void HtmlSyntaxHighLighter::setFormatFor(Construct construct, const QColor& color)
{
...
void HtmlSyntaxHighLighter::setFormatFor(Construct construct, const QFont& font)
{
	QTextCharFormat format;
	format.setFont(font);
	setFormatFor(construct, format);
